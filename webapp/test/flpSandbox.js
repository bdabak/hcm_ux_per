					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Personel İstihdam Talebi",
									"targetURL": "#comthyuxper-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"comthyuxper-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.thy.ux.per",
									"url": sap.ui.require.toUrl("com/thy/ux/per")
								}
							}
						}
					}
